...
class example_application:
    ...
    #     jaw_position = self.PSM.jaw.setpoint_jp()
    ...
    def close_jaw(self):
        ...
        self.PSM.jaw.close().wait()  # close the jaw

    def open_jaw(self):
        self.PSM.jaw.open().wait()   # open the jaw
            ...
            while not done:
                ...
                if is_there_a_key_press():
                    ...
                    if c == 'q':
                        ...
                        self.close_jaw()
                        print('Jaw closed')  # feedback for closing the jaw
                    elif c == 'o':
                        self.open_jaw()  # open the jaw when 'o' is pressed
                        print('Jaw opened')  # feedback for opening the jaw
